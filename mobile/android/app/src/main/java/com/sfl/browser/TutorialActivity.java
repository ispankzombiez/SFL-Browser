...
public class TutorialActivity extends AppCompatActivity {
    ...
    private String getTutorialContent() {
        return "<h2>SFL Browser - Tutorial Guide</h2>" +
                "<p>Welcome to SFL Browser, your companion app for Sunflower Land!</p>" +
                ...
                "<h3>App Modes</h3>" +
                "<p><b>Notifications Only Mode (Default):</b> When enabled, the app opens directly to the Settings page. This mode disables the web browser and keeps only the notification system active. You can toggle this mode in Settings.</p>" +
                "<p><b>Browser Mode:</b> When Notifications Only is disabled, the app opens to the web browser, allowing you to play Sunflower Land directly within the app.</p>" +
                ...
                "<ul>" +
                "<li><b>Crops:</b> Get notified when crops are ready to harvest</li>" +
                "<li><b>Animals:</b> Receive alerts for animal care needs</li>" +
                "<li><b>Resources:</b> Be notified when resources are ready to collect</li>" +
                "<li><b>Cooking:</b> Get alerts for cooking completion</li>" +
                "<li><b>Flowers:</b> Receive flower harvesting notifications</li>" +
                "<li><b>Fruits:</b> Get alerts for fruit harvesting</li>" +
                "<li><b>And more:</b> Many other categories available to customize</li>" +
                "</ul>" +
                ...
                "<p><b>Browser Controls Toggle:</b> In Settings, you can hide or show browser navigation controls for a cleaner game view.</p>" +
                ...
                "<h3>Starting and Stopping the Worker</h3>" +
                "<p>The notification worker runs in the background to check for updates. You can manually:</p>" +
                "<ul>" +
                "<li><b>Start Worker:</b> Manually enable the background notification service</li>" +
                "<li><b>Stop Worker:</b> Manually disable the background notification service</li>" +
                "<li><b>Auto Start Worker:</b> Enable automatic starting when the app launches (toggleable in Settings)</li>" +
                "</ul>" +
                ...
                "<li>Use the three tabs in browser mode to quickly switch between your Farm, the SFL Wiki, and other resources with a 3 finger swipe left or right</li>" +
                ...
                "<li>Keep your API Key secure - it is sensitive account information. This app only uses it, on your behalf to fetch your game data and does not share it with third parties or transmit it elsewhere.</li>" +
                "</ul>" +
                
                "<h3>Need Help?</h3>" +
                "<p>For support, questions, or to report issues, join the official Sunflower Land Discord:</p>" +
                "<p><a href=\"https://discord.com/channels/880987707214544966/1314031342182338651\">SFL Browser Support Channel</a></p>" +
                "<p>You can also find the project source code on GitHub for additional information and to contribute.</p>" +
                "<p>Thank you for using SFL Browser!</p>";
    }
}
