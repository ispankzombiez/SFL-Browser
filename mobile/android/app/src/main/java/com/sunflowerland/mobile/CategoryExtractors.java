...
public class CategoryExtractors {
     ...
     */
    public static List<com.sunflowerland.mobile.models.SickAnimal> extractSickAnimals(JsonObject farmData) {
        DebugLog.log("🐔 Sick Animals: Extracting animal states for sick detection...");
        List<com.sunflowerland.mobile.models.SickAnimal> sickAnimals = new ArrayList<>();
                    ...
                    if (henHouse.has("animals")) {
                        ...
                        for (String animalId : henHouseAnimals.keySet()) {
                            try {
                                ...
                                com.sunflowerland.mobile.models.SickAnimal sickAnimal = 
                                    new com.sunflowerland.mobile.models.SickAnimal(type, animalId, state, currentTime);
